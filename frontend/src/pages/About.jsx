    ...
    <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col gap-6 px-8 py-8 border-b border-white/5 bg-black/20 backdrop-blur-xl">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white">About TaskMaster</h1>
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <motion.div
            ...
            className="rounded-xl border border-white/10 bg-gradient-to-br from-white/5 to-white/2 p-8 backdrop-blur-sm text-center"
          >
          ...
          >
            <h3 className="text-2xl font-bold text-white mb-6">Built With</h3>
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <a
                ...
                className="flex items-center gap-2 px-6 py-3 rounded-lg bg-white/5 border border-white/10 text-white hover:bg-white/10 transition-colors"
              >
